...
function HeroSection() {
  ...
  return (
    ...
    >
      {/* bg-Italic */}
      <div className="bg-mainColor h-[200%] w-full hidden lg:block fixed -left-[70%] -rotate-[15deg] z-0 top-0"></div>
      ...
      {/* content */}
      <div className="col-span-12 lg:col-span-6 flex flex-col justify-center z-10 px-5 md:ms-5">
        <div className="w-full flex sm:justify-center sm:content-center lg:justify-start lg:content-normal">
          <span className="hidden lg:block bg-mainColor lg:w-[8%] lg:h-[6%] xl:w-[5%] xl:h-[6%] rounded-md mr-5 relative top-6"></span>
        ...
        <p
          ...
          style={{ lineHeight: 3 }}
        >
          I'm a passionate front-end developer from Egypt, dedicated to building
          modern, responsive, and user-friendly web interfaces. I love crafting
          experiences that are both visually appealing and highly functional to
          improve the digital lives of users.
        </p>
        ...
        <div className="mt-6 mb-6 flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-5">
          <Button
            title="More About Me"
            icon={ArrowLeft}
            handelClick={handleClick}
          ...
          >
            <span className="font-medium tracking-wide uppercase whitespace-nowrap">
              Download CV
            </span>
